...
public class MapInfoManager
{
	...
	{
		mapName = _mapName;
		PhotonNetwork.InstantiateRoomObject($"Prefabs/Map/{mapName}", new Vector3(-0.5f, -0.5f, 0f), Quaternion.identity);
		//CurrentGrid = go.GetComponent<Grid>();

		// Collision 관련 파일
		TextAsset txt = Resources.Load<TextAsset>($"MapInfo/{mapName}");
